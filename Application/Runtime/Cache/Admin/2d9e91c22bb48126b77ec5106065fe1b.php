...
.AreaS { background-color: #56b4f8 !important; color: #fff !important; }
    ...
    <form action="<?php echo U('Mechanism/do_jiaoshi');?>" method="post" onSubmit="return check();" enctype="multipart/form-data">
     <div class="modal-body">       
		<table style="width: 100%;">
          <tr style="margin-bottom:5px;">
            <td>教师名称</td>
            <td><input type="text" class="form-control" name="title" placeholder="名称" id="name" value="<?php echo ($data['title']); ?>"><font color="red">*本可以为空*</font></td>
          </tr>
          <tr>        
             <td>简介</td>
