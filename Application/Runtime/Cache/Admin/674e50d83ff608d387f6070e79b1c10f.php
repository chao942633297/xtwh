...
<div>
  <div style="margin:24px;">
   <div style="margin:24px;">
      <a style="margin-left:20px;width:100px;" type="button" class="btn btn-primary" href="<?php echo U('Mechanism/jigou');?>">添加机构</a>
    </div>
...
<script type="text/javascript">
  ...
  function formatLink(id) {
    return "<a class='btn btn-success' href='tream/id/"+id+"'>师资团队</a>&nbsp;<a class='btn btn-success' href='info/id/"+id+"'>课程列表</a>&nbsp;<a class='btn btn-primary' href='javascript:' onclick='fans("+id+");'>编辑</a>&nbsp;<a class='btn btn-danger' href='javascript:' onclick='follow("+id+");'>删除</a>";
  };
