			   ...
			   <div id="collapseT" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingT">
			      <div class="panel-body" style="padding: 0px;">
			        <ul class="navul">
						...
						<li><a href="javascript:" funtype="用户管理" funtypeicon="glyphicon glyphicon-cog"  data-url="<?php echo U('Admin/User/index2');?>" class="glyphicon glyphicon-user" onclick="OpenPage($(this));">&nbsp;三级分销会员管理</a></li>
						<li><a href="javascript:" funtype="用户管理" funtypeicon="glyphicon glyphicon-cog"  data-url="<?php echo U('Admin/User/index3');?>" class="glyphicon glyphicon-user" onclick="OpenPage($(this));">&nbsp;学员管理-(家长的子账号)</a></li>
			        </ul>
			      </div>
			    </div>
			  </div>
			 ...
			 <div class="panel panel-default">
			  ...
			  <div class="panel panel-default">
			    ...
			    <div id="collapsefor1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingfor">
			      <div class="panel-body" style="padding: 0px;">
			         <ul class="navul">
			        	<li><a href="javascript:" funtype="提现" funtypeicon="glyphicon glyphicon-cog"  data-url="" class="glyphicon glyphicon-th-large" onclick="OpenPage($(this));">&nbsp;提现管理</a></li>
			        </ul>
			      </div>
			    </div>
			  </div>
			    ...
			    <div id="collapseThree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree">
			      <div class="panel-body" style="padding: 0px;">
			        <ul class="navul">
			        	<li><a href="javascript:" funtype="佣金管理" funtypeicon="glyphicon glyphicon-cog"  data-url="<?php echo U('Admin/Account/index');?>" class="glyphicon glyphicon-yen" onclick="OpenPage($(this));">&nbsp;佣金列表</a></li>
			        </ul>
			      </div>
			    </div>
			  </div>
			  <!-- 	<div class="panel panel-default">
			    ...
			    <div id="collapseF" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingF">
			      <div class="panel-body" style="padding: 0px;">
			        <ul class="navul">
			        	<li><a href="javascript:" funtype="财务对账" funtypeicon="glyphicon glyphicon-cog"  data-url="" class="glyphicon glyphicon-arrow-right" onclick="OpenPage($(this));">&nbsp;直营充值列表</a></li>
			        	<li><a href="javascript:" funtype="财务对账" funtypeicon="glyphicon glyphicon-cog"  data-url="" class="glyphicon glyphicon-share-alt" onclick="OpenPage($(this));">&nbsp;非直营充值列表</a></li>
			        	<li><a href="javascript:" funtype="财务对账" funtypeicon="glyphicon glyphicon-cog"  data-url="" class="glyphicon glyphicon-usd" onclick="OpenPage($(this));">&nbsp;分销佣金列表</a></li>			        	
			        	<li><a href="javascript:" funtype="财务对账" funtypeicon="glyphicon glyphicon-cog"  data-url="" class="glyphicon glyphicon-object-align-bottom" onclick="OpenPage($(this));">&nbsp;合作机构列表</a></li>	
			        </ul>
			      </div>
			    </div>
			    <!-- <div class="panel panel-default">
