...
<div>
  <div style="margin:24px;">
   <div style="margin:24px;">
      <font color="red"><<<?php echo ($name); ?>>></font>-------<a style="margin-left:20px;width:100px;" type="button" class="btn btn-primary" href="<?php echo U('Mechanism/jiaoshi',array('pid'=>$pid));?>">添加老师</a>
    </div>
...
<script type="text/javascript">
  ...
  function formatLink(id) {
    return "<a class='btn btn-primary' href='/Admin/Mechanism/edit_jiaoshi/id/"+id+"'  >编辑</a>&nbsp;<a  class='btn btn-danger' id='com"+id+"' href='javascript:' onclick='follow("+id+");'>删除</a>";
  };
 
  function follow(id){
    if (confirm("你确定要删除吗?")) {
      $.ajax({
        url: "<?php echo U('/Admin/Mechanism/del_jiaoshi');?>",
        dataType: "json",
        data: {"id": id},
        type: "GET",   
