...
/**
  * 提供访问乐视云视频开放平台的接口
  */
class LetvCloudV1Controller extends Controller {
		
		public $user_unique='82128f0e5b';
		public $secret_key='5e9480a7778c62a7b0c3c5b3400bb2cc';
        ...
        public function saveVideo(){
            ...
            if (isset($_GET['token']) && !empty(trim($_GET['token']))) {
                ...
                $data =  $this->videoUploadResume($token,$uploadtype);
                $dd = json_decode($data,true);
                $_SESSION['video_id'] = $dd['data']['video_id'];
                $_SESSION['video_unique'] = $dd['data']['video_unique'];
                echo $data;
            }else{
                $data =  $this-> videoUploadInit($video_name, $client_ip, $file_size,$uploadtype);
                $dd = json_decode($data,true);
                $_SESSION['video_id'] = $dd['data']['video_id'];
                $_SESSION['video_unique'] = $dd['data']['video_unique'];
                echo $data;
